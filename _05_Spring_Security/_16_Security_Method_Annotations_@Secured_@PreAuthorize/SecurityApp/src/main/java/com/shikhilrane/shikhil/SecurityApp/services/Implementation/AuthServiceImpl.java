...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponseDto loginUser(LoginDto loginDto) {
        ...
        String refreshToken = jwtService.generateRefreshToken(user);                                    // Generate JWT refresh token for the user
        sessionService.generateNewSession(user, refreshToken);                                          // Generate New Session for the user according to refreshToken
    ...
    public LoginResponseDto refreshToken(String getFirstRefreshTokenFromArray) {    // Method to generate a new access token using the refresh token
        ...
        sessionService.validateSession(getFirstRefreshTokenFromArray);              // Validate the session for the
