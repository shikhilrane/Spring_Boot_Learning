...
class SecurityAppApplicationTests {
    ...
    @Test
    void getIdOfUser(){
        User user = new User(4L, "skr@mail.com", "1234");   // Created a user

        String token = jwtService.generateUserToken(user);                     // Created a token using generateUserToken() from JwtService
